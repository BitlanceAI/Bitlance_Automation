...
const servicePlans = [
  ...
  },
  {
    ...
    features: ['Unlimited articles', 'Custom content strategy', 'Full backlink outreach', 'Dedicated GEO manager', 'Weekly reporting calls', 'Custom integrations', 'SLA guarantee'],
    missing: [],
    cta: 'Contact Sales',
