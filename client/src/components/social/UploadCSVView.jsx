        ...
        <div className="flex-1 p-8 bg-[#f5f5f5] overflow-y-auto w-full">
            <div className="max-w-4xl mx-auto space-y-8">
                <div>
                    ...
                    <p className="text-sm font-mono text-gray-400 mt-1 uppercase tracking-widest">Bulk schedule multiple posts at once</p>
                </div>
                
                <div className="bg-white border-2 border-[#d0d0d0] rounded-[2px] p-12 text-center border-dashed hover:border-[#26cece] transition-colors cursor-pointer group shadow-[0_2px_16px_0_rgba(0,0,0,0.06)]">
                    ...
                    <h3 className="text-lg font-bold text-gray-900 font-['Space_Grotesk'] uppercase tracking-tight mb-2">Drag &amp; Drop your CSV file here</h3>
                    <p className="text-sm text-gray-400 font-mono tracking-widest uppercase mb-6">maximum file size 10MB</p>
                ...
                <div className="bg-white border border-[#e0e0e0] rounded-[2px] p-6 flex flex-col sm:flex-row items-start gap-4">
                    <Info className="w-5 h-5 text-[#26cece] shrink-0 mt-0.5" />
                    <div className="flex-1">
                        <h4 className="text-[14px] font-bold text-gray-900 font-mono uppercase tracking-widest mb-2">CSV Format Requirements</h4>
                        <p className="text-[12px] font-sans text-gray-500 leading-relaxed mb-4 max-w-2xl">
                        ...
                        <button className="text-[12px] font-mono tracking-widest uppercase flex items-center gap-1.5 px-4 py-2 border border-[#d0d0d0] hover:border-[#26cece] hover:text-[#26cece] text-gray-500 rounded-[2px] transition-colors shrink-0">
