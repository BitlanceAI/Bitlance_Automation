        ...
        <div className="flex-1 p-8 bg-transparent overflow-y-auto w-full">
            <div className="max-w-4xl mx-auto space-y-8">
                <div>
                    ...
                    <p className="text-sm font-mono text-white/40 mt-1 uppercase tracking-widest">Never miss a trending holiday or awareness day</p>
                </div>
                ...
                <div className="bg-[#26cece]/10 border border-[#26cece]/40 rounded-[2px] p-6 flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-[13px] font-sans text-white/70 mb-3">
                ...
                <div>
                    <h3 className="text-[14px] font-bold text-white font-mono uppercase tracking-widest mb-4 flex items-center gap-2 border-b border-white/10 pb-3">
                        <Clock className="w-4 h-4 text-[#26cece]" /> Upcoming Dates
                    </h3>
                    <div className="space-y-3">
                        {upcomingDays.map((day, i) => (
                            <div key={i} className="bg-white/5 border border-white/10 rounded-[2px] p-4 flex flex-col md:flex-row md:items-center justify-between gap-4 transition-colors">
                                <div className="flex items-center gap-4">
                                    <div className="flex flex-col items-center justify-center w-14 h-14 bg-transparent border border-white/10 rounded-[2px]">
                                        <span className="text-[10px] font-mono uppercase tracking-widest text-white/40">{day.date.split(' ')[0]}</span>
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-2 mt-1 hidden md:flex">
                                            <span className="text-[10px] font-mono text-white/50 uppercase tracking-widest bg-transparent border border-white/10 px-2 py-0.5 rounded-[2px]">{day.type}</span>
