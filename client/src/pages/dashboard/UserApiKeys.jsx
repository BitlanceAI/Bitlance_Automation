            ...
            <header className="bg-white dark:bg-slate-800 border-b border-gray-200 dark:border-slate-700 sticky top-0 z-10">
                <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
                    ...
                    <button
                        ...
                        className="flex items-center gap-1.5 px-4 py-2 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 dark:bg-slate-700 dark:hover:bg-slate-600 dark:text-slate-200 border border-indigo-100 dark:border-slate-600 rounded-xl text-sm font-semibold transition-all duration-200"
                    >
