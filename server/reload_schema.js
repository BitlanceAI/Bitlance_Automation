...
async function run() {
    await supabase.rpc('reload_schema'); // just try calling a fake rpc, it won't work for reload.
    // the correct way to reload schema from sql is: NOTIFY pgrst, 'reload schema'
}
